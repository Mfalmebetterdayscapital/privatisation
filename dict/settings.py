...
ALLOWED_HOSTS = ['privatisation-production-a5e7.up.railway.app','127.0.0.1']
CSRF_TRUSTED_ORIGINS=['https://privatisation-production-a5e7.up.railway.app','https://127.0.0.1']
